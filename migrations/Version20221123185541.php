...
final class Version20221123185541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE exercices (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(255) NOT NULL, enonce LONGTEXT NOT NULL, resultat VARCHAR(255) NOT NULL, created_at DATETIME NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
